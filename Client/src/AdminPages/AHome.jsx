...
//   //   try {
//   //     const response = await axios.get('http://localhost:8800/api/quizes/getQuizResult');
...
//       {/* <div className="App">
//         <h1>User Quiz Summaries</h1>
//         <table className="min-w-full bg-white">
//           <thead>
//             <tr>
//               <th className="py-2 px-4 border-b-2 border-gray-300 text-left leading-4 text-blue-500 tracking-wider">Rank</th>
//               <th className="py-2 px-4 border-b-2 border-gray-300 text-left leading-4 text-blue-500 tracking-wider">Name</th>
//               <th className="py-2 px-4 border-b-2 border-gray-300 text-left leading-4 text-blue-500 tracking-wider">Total Marks</th>
//             </tr>
//           </thead>
//           <tbody>
//             {userQuizSummaries.map(user => (
//               <tr key={user.id}>
//                 <td className="py-2 px-4 border-b border-gray-300">{user.rank}</td>
//                 <td className="py-2 px-4 border-b border-gray-300">{user.name}</td>
//                 <td className="py-2 px-4 border-b border-gray-300">{user.total}</td>
//               </tr>
//             ))}
//           </tbody>
//         </table>
...
//         </div>
//         <div className="w-1/2">
//           <h1 className='text-xl ml-4 font-semibold'>VideoUnit Income</h1>
