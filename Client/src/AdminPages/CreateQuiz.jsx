...
const CreateQuiz = () => {
    ...
    const handleSubmit = async (event) => {
        ...
        try {
            ...
            Swal.fire({
                title: 'Successfully added questions',
                text: 'You have successfully added questions for the quiz.',
                icon: 'success',
            ...
            <div className="rounded-lg md:px-10 py-8 w-full">
                <form onSubmit={handleSubmit}>
                    {questions.map((question, qIndex) => (
                        <div key={qIndex} className="mb-4 px-4 py-3.5 rounded-lg shadow-md">
                            <div className="mb-4">
                            ...
                            <div className="mb-2 mt-3 text-center w-9/12 ml-auto mr-auto">
