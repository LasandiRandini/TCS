...
const EditVideo = () => {
  ...
  const filteredVideos = videos.filter(
    (video) =>
      ...
      video.v_year.toString().includes(searchQuery)
  );
  ...
  return (
    <div className="bg-gray-200 min-h-screen">
      ...
      <input
        type="text"
        placeholder="Search by Unit Name or Year"
        className="border border-gray-400 bg-white ml-4 bg-opacity-40 rounded-md  px-3 py-2 mt-4 w-1/4"
        value={searchQuery}
