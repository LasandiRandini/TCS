...
//         <h1 className="text-2xl font-bold mb-6">Receipt Data</h1>
//         {error ? (
...
//   const filterData = (status, year) => {
//     let filtered = data;

//     // Apply status filter
//     if (status !== 'All') {
//       filtered = filtered.filter(item => item.permission.toLowerCase() === status.toLowerCase());
//     }
...
//                   <td className="px-4 py-2">{item.name}</td>
//                   <td className="px-4 py-2">{item.al_year}</td>
//                   <td className="px-4 py-2">{item.contact_no}</td>
//                   <td className="px-4 py-2">{item.price}</td>
//                   <td className="px-4 py-2">{item.unit_name}</td>
//                   <td className="px-4 py-2">{item.permission}</td>
//                 </tr>
