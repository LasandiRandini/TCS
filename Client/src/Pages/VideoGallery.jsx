...
const VideoGallery = () => {
  ...
  return (
    ...
    >
      <div className="container mt-12 px-2 md:px-12 p-4 min-h-screen">
        <h1 className="text-3xl text-white font-bold mb-6">{unitName}</h1>
          ...
          <div className="flex-1 lg:mr-6 mb-6 lg:mb-0">
            {selectedVideo && (
              <div className="video-player">
                ...
                <div className="mt-2 text-center text-white  text-2xl">{selectedVideo.video_name}</div>
              </div>
            )}
          </div>
