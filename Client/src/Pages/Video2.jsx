...
//       try {
//         const response = await axios.get(
//           `http://localhost:8800/api/o_videos/getApprovedUnits/${user.id}`
//         );
//         setApprovedVideos(response.data);
//       } catch (err) {
//         setError("Failed to fetch approved videos");
//       }
//     };
...
//               <div
//                 key={index}
//                 className="bg-green-100 rounded-lg p-8 shadow-md hover:shadow-lg transition duration-300 relative"
//               >
//                 <h3 className="text-xl font-semibold mb-2">{video.unit_name}</h3>
//                 <p className="text-gray-600 mb-4">{video.unit_description}</p>
//                 <p className="text-lg font-bold text-black-500">{video.price} LKR</p>
