  ...
  return (
    <div className="flex justify-center items-center min-h-screen bg-gray-300">
      <div className="container mx-auto p-6">
        <h1 className="text-1xl font-bold mb-4">Practicals සදහා time slots තෝරා ගැනිමට අදාල practical එක තෝරා ගෙන, අදාල time slot එක තෝරා ගන්න.</h1>
        {error ? (
...
//     <div className="flex justify-center items-center min-h-screen bg-gray-300">
//       <div className="container mx-auto p-6">
//       <h1 className="text-1xl font-bold mb-4">Practicals සදහා time slots තෝරා ගැනිමට අදාල prctical එක තෝරා ගෙන, අදාල time slot එක තෝරා ගන්න.
// </h1>
//         {error ? (
//           <p className="text-red-500 text-center">Error: {error}</p>
...
//         Swal.fire({
//           icon: 'error',
//           title: 'Error fetching practicals',
//           text: err.response ? err.response.data.error : 'Network Error',
//         });
//         console.error('Error fetching practicals:', err.message);
//       }
//     };
...
//           text: 'Expected an array but got a different format',
//         });
//         console.error('Expected an array but got:', response.data);
//       }
//     } catch (err) {
...
//       Swal.fire({
//         icon: 'error',
//         title: 'Error voting for time slot',
//         text: err.response ? err.response.data.error : 'Network Error',
//       });
//       console.error('Error voting for time slot:', err.message);
//     }
...
//           Practicals සදහා time slots තෝරා ගැනිමට අදාල practical එක තෝරා ගෙන, අදාල time slot එක තෝරා ගන්න.
//         </h1>
//         {error ? (
//           <p className="text-red-500 text-center">Error: {error}</p>
//         ) : (
