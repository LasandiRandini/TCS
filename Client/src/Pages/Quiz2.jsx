...
//                     </div>
//                 </div> */}
//                 <div className="container mx-auto p-6 bg-gradient-to-r from-purple-500 to-indigo-600 rounded-lg shadow-lg md:px-10 py-12 w-full">
//   <h1 className="text-4xl text-center font-extrabold text-white mb-6">Quiz Result</h1>
...
//     <button
//       onClick={() => navigate('/PHome')}
//       className="mt-6 bg-indigo-700 hover:bg-indigo-800 text-white font-semibold py-2 px-4 rounded transition duration-300"
//     >
//       Go Home
//     </button>
//   </div>
