...
//                 <button
//                   onClick={() => handleOpenPlaylist(video.unit_id)}
//                   className={`bg-red-500 text-white px-6 mr-5 py-2 mt-4 rounded hover:bg-red-700 transition duration-300 ${enrollmentStatus[video.unit_id] ? "opacity-50 cursor-not-allowed" : ""}`}
