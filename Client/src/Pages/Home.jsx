...
//             About Us
//           </h2>
//           <p className="text-center text-gray-700 font-bold mb-5 text-2xl">ලංකාව පුරා සිටින තාක්ශනවේදීන්ගේ සරසවි සිහින යතාර්තයක් කල සොදුරු ET පන්තිය
...
//               <img src={ homei} alt=" homei" className="lg:h-[400px] rounded-lg shadow-lg" />
//             </div>
//             <div className="flex flex-col md:flex-row items-center gap-8">
//             <div className="md:w-1/4">
//               <img src={ homei} alt=" homei" className="lg:h-[400px] rounded-lg shadow-lg" />
