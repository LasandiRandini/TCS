...
// //   return (
// //     <div className="min-h-screen bg-cover bg-center" style={{ backgroundImage: `url(${ONLINE})` }}>
// //       <div className="container mx-auto px-4 py-20">
// //         <input
// //           type="text"
// //           placeholder="Search by Unit Name"
// //           className="border border-gray-400 rounded-md mb-4 px-3 py-2 w-1/4"
// //           value={searchQuery}
...
// //               <div
// //                 key={index}
// //                 className="bg-white text-black rounded-lg p-10 shadow-md hover:shadow-lg transition duration-300 relative border border-gray-600"
// //               >
...
// //                     className="bg-red-500 text-white px-6 py-2 rounded hover:bg-red-700 transition duration-300"
// //                   >
...
//   return (
//     <div className="md:px-12 p-4 min-h-screen" style={{ backgroundImage: `url(${CLASS})` }}>
...
//                   <button
//                     onClick={() => handleOpenPlaylist(video.unit_id)}
//                     className="bg-red-500 text-white px-6 py-2 mt-4 rounded hover:bg-red-700 transition duration-300"
//                   >
//                     පාඩම් මාලාව නරඹන්න
//                   </button>
//                 </div>
          ...
          {error ? (
            ...
            filteredVideos.map((video, index) => (
              ...
              >
                <h3 className="text-xl font-semibold mb-2">{video.unit_name}</h3>
                <p className="mb-4">{video.unit_description}</p>
                <div className="absolute top-0 right-0 mt-12 mr-20">
                  <button
                    onClick={() => handleOpenPlaylist(video.unit_id)}
                    className="bg-red-500 text-white px-6 py-2 mt-4 rounded hover:bg-red-700 transition duration-300"
                  >
